...
<h1>Franchise Opportunities Form</h1>
    ...
    <a style = "color:white;" href="/franchise_page" title="back to index table"><i class="fa fa-refresh btn btn-info float-right margin-right:50px;" style="font-size:18px;"> Refresh</i></a>
